...
public class DrawOvalMouseListener implements MouseListener, MouseMotionListener {
    ...
    public DrawOvalMouseListener(Graphics2D graphics, Canvas canvas, JPanel currentColorPanel, JSlider strokeSlider, JButton ovalButton, WhiteBoardServerService serverService) {
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1 && ovalButton.getModel().isPressed()) {
            ...
            ovalButton.getModel().setPressed(false);
            ovalButton.getModel().setArmed(false);
            canvas.repaint();
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        graphics.drawOval(tx, ty, width, height);
        x2 = e.getX();
        y2 = e.getY();
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        graphics.drawOval(tx, ty, width, height);
        try {
            serverService.addShape(new Oval(tx, ty, width, height, currentColorPanel.getBackground(), strokeSlider.getValue()));
    ...
    public void mouseMoved(MouseEvent e) {
        if (!ovalButton.getModel().isPressed()) {
            canvas.removeMouseListener(this);
            canvas.removeMouseMotionListener(this);
            canvas.setCursor(Cursor.getDefaultCursor());
            ovalButton.getModel().setPressed(false);
